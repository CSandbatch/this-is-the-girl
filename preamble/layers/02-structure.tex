...
\providecommand{\CyclePartHead}[1]{%
  \par
  \medskip
  \TexGraphOuterLine{\textit{#1}}%
  \medskip
}
\providecommand{\CyclePartHeadTight}[1]{%
  \par
  \smallskip
  \TexGraphOuterLine{\textit{#1}}%
  \smallskip
}
\providecommand{\CycleInterMovementSpace}{\par\vspace{0.75\baselineskip}}
