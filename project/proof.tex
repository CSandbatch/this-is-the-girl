% TexGraph proof driver (full book)
%
% !TEX program = lualatex
%
% Build (LuaLaTeX via latexmk, recommended):
%   latexmk -pdflua -interaction=nonstopmode -halt-on-error proof.tex
%
\documentclass[10pt,twoside]{book}

% Required by preamble layers (guards against compiling layers directly).
\def\TexGraphDriver{proof}

% Preamble layers (capability + geometry)
...
% D'esir — Op. IV
\Opus{desir}{D'esir}{body/opus-IV-desir/00-section-title/00-section-title.tex}{%
